...
//        mMessage.setMovementMethod(LinkMovementMethod.getInstance()); // clickable link support
    ...
    private void setSenderDisplayName(Message message) {
        ...
        if (message.isGroupChannel()) {
            ...
            if (StringUtils.isValid(message.getSenderFullname())) {
                mSenderDisplayName.setText(message.getSenderFullname());
            } else {

                String senderId = message.getSender();
                String path = "apps/" + ChatManager.Configuration.appId + "/contacts/" + senderId + "/firstname";
                ...
                mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mSenderDisplayName.setText(dataSnapshot.getValue(String.class));
