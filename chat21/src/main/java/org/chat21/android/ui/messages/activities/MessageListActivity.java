...
import org.chat21.android.core.messages.handlers.MyRecyclerView;
import org.chat21.android.core.messages.listeners.ConversationMessagesListener;
import org.chat21.android.core.messages.listeners.OnVerticalScrollListener;
...
//        }
    ...
    private void registerViews() {
        ...
        recyclerView = (MyRecyclerView) findViewById(R.id.main_activity_recycler_view);
        ...
        recyclerView.setOnScrollListener(new OnVerticalScrollListener() {
            ...
            public void onScrolledToTop() {
                ...
                conversationMessagesHandler.loadMore(mLinearLayoutManager);
            }
        });
    }
